...
2. Поля глобального поиска: строка запроса поиска по имени; выбор сортировки по цене; количество продуктов, отображаемых на
   странице; а также кнопка для выполнения поиска
